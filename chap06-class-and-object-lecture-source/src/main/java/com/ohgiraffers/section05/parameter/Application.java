...
//        pt.variableLengthArrayparameter();    //인자가 아무것도 없는 경우 에러 발생
        ...
        pt.variableLengthArrayparameter("박진영", "탁구"); //1개 가능
        pt.variableLengthArrayparameter("박민욱", "탁구","낚시","볼링"); //여러개 가능
        pt.variableLengthArrayparameter("박시후", new String[] {"테니스","서예","농구"}); //배열도 가능
    }
