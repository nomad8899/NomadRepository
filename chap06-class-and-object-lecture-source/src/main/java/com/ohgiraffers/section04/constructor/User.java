...
public class User {
     ...
     * 2. 매개변수 있는 생성자
     *   기본생성자는 자바 컴파일러가 자동으로 추가해주는 구문이지만 명시적으로 작성할 수있다.
    ...
    /* 동일한 이름의 생성자 혹은 메소드를 한 클래스안에서 작성하는것은 불가능하다.(Compile Error)
     */
//    public User()
...
//        this.enrollDate = enrollDate;
        ...
        * 괄호 안에 매개변수의 타입, 개수, 순서에 맞는 생성자를 호출하고 복귀한다. (메소드와 동일)
        * this() 는 가장 첫 줄에 선언해야 하며, 그렇지 않은 경우 Compile error 가 발생한다.
        * */
    ...
    public String getInformation() {
        return "User [id= " + this.id + ", pewd= " + this.pwd + " , name= " + this.name + ", enrollDate=" + this.enrollDate + "]";
    }
}
