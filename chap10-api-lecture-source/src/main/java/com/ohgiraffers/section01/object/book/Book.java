...
public class Book {
    ...
    public boolean equals(Object obj) {
        ...
        /*title 필드가 null인 경우 다른 인스턴스의 title이 null아니면 false 반환 */
        if (this.title == null) {
            if (other.title != null) {
                return false;
            }
            ...
            * 그렇지 않은 경우 false 반환
            *
            * String 클래스의 equals() 메서드를 오버라이딩 해 두었기 때문에
    ...
    public int hashCode() {
        int result = 1;
        /* 필드마다 곱해줄 소수값 선언
        * 31을 소수이기 때문에 연산 시 동일한 hashCode 값이 나오지 않을 확률을 증가시킨다.
        ...
        * */
        ...
        /* Sting 클래스의 hashCode 메소드는 이미 재정의 되어있다.
